...
#ifdef HAVE_LIBHANGUL
static const ucschar hangul_keyboard_table[] = {
	'r',	/*  1: [ㄱ]  3131  HANGUL LETTER KIYEOK */
	'R',	/*  2: [ㄲ]  3132  HANGUL LETTER SSANGKIYEOK */
	0,	/*  3: [ㄳ]  3133  HANGUL LETTER KIYEOK-SIOS */
	's',	/*  4: [ㄴ]  3134  HANGUL LETTER NIEUN */
	0,	/*  5: [ㄵ]  3135  HANGUL LETTER NIEUN-CIEUC */
	0,	/*  6: [ㄶ]  3136  HANGUL LETTER NIEUN-HIEUH */
	'e',	/*  7: [ㄷ]  3137  HANGUL LETTER TIKEUT */
	'E',	/*  8: [ㄸ]  3138  HANGUL LETTER SSANGTIKEUT */
	'f',	/*  9: [ㄹ]  3139  HANGUL LETTER RIEUL */
	0,	/* 10: [ㄺ]  313A  HANGUL LETTER RIEUL-KIYEOK */
	0,	/* 11: [ㄻ]  313B  HANGUL LETTER RIEUL-MIEUM */
	0,	/* 12: [ㄼ]  313C  HANGUL LETTER RIEUL-PIEUP */
	0,	/* 13: [ㄽ]  313D  HANGUL LETTER RIEUL-SIOS */
	0,	/* 14: [ㄾ]  313E  HANGUL LETTER RIEUL-THIEUTH */
	0,	/* 15: [ㄿ]  313F  HANGUL LETTER RIEUL-PHIEUPH */
	0,	/* 16: [ㅀ]  3140  HANGUL LETTER RIEUL-HIEUH */
	'a',	/* 17: [ㅁ]  3141  HANGUL LETTER MIEUM */
	'q',	/* 18: [ㅂ]  3142  HANGUL LETTER PIEUP */
	'Q',	/* 19: [ㅃ]  3143  HANGUL LETTER SSANGPIEUP */
	0,	/* 20: [ㅄ]  3144  HANGUL LETTER PIEUP-SIOS */
	't',	/* 21: [ㅅ]  3145  HANGUL LETTER SIOS */
	'T',	/* 22: [ㅆ]  3146  HANGUL LETTER SSANGSIOS */
	'd',	/* 23: [ㅇ]  3147  HANGUL LETTER IEUNG */
	'w',	/* 24: [ㅈ]  3148  HANGUL LETTER CIEUC */
	'W',	/* 25: [ㅉ]  3149  HANGUL LETTER SSANGCIEUC */
	'c',	/* 26: [ㅊ]  314A  HANGUL LETTER CHIEUCH */
	'z',	/* 27: [ㅋ]  314B  HANGUL LETTER KHIEUKH */
	'x',	/* 28: [ㅌ]  314C  HANGUL LETTER THIEUTH */
	'v',	/* 29: [ㅍ]  314D  HANGUL LETTER PHIEUPH */
	'g',	/* 30: [ㅎ]  314E  HANGUL LETTER HIEUH */
	'k',	/* 31: [ㅏ]  314F  HANGUL LETTER A */
	'o',	/* 32: [ㅐ]  3150  HANGUL LETTER AE */
	'i',	/* 33: [ㅑ]  3151  HANGUL LETTER YA */
	'O',	/* 34: [ㅒ]  3152  HANGUL LETTER YAE */
	'j',	/* 35: [ㅓ]  3153  HANGUL LETTER EO */
	'p',	/* 36: [ㅔ]  3154  HANGUL LETTER E */
	'u',	/* 37: [ㅕ]  3155  HANGUL LETTER YEO */
	'P',	/* 38: [ㅖ]  3156  HANGUL LETTER YE */
	'h',	/* 39: [ㅗ]  3157  HANGUL LETTER O */
	0x116a,	/* 40: [ㅘ]  3158  HANGUL LETTER WA */
	0x116b,	/* 41: [ㅙ]  3159  HANGUL LETTER WAE */
	0x116c,	/* 42: [ㅚ]  315A  HANGUL LETTER OE */
	'y',	/* 43: [ㅛ]  315B  HANGUL LETTER YO */
	'n',	/* 44: [ㅜ]  315C  HANGUL LETTER U */
	0x116f,	/* 45: [ㅝ]  315D  HANGUL LETTER WEO */
	0x1170,	/* 46: [ㅞ]  315E  HANGUL LETTER WE */
	0x1171,	/* 47: [ㅟ]  315F  HANGUL LETTER WI */
	'b',	/* 48: [ㅠ]  3160  HANGUL LETTER YU */
	'm',	/* 49: [ㅡ]  3161  HANGUL LETTER EU */
	0x1174,	/* 50: [ㅢ]  3162  HANGUL LETTER YI */
	'l',	/* 51: [ㅣ]  3163  HANGUL LETTER I */
};
static char*
get_hic_preedit_string(HangulInputContext *hic)
{
...
static char*
get_hic_commit_string(HangulInputContext *hic)
{
...
static void
hic_preedit_update(struct gui_priv *this, struct widget *wi)
{
	char *preedit;
	char *text=NULL;
	preedit = get_hic_preedit_string(this->hic);
	if (preedit != NULL && strlen(preedit) > 0) {
		text=g_strdup_printf("%s", preedit);
		g_free(wi->preedit);
		wi->preedit=text;
	} else {
		if (wi->preedit)
...
static void
hic_commit(struct gui_priv *this, struct widget *wi)
{
	char *commit;
	char *text=NULL;
	commit = get_hic_commit_string(this->hic);
        if (commit != NULL && strlen(commit) > 0) {
		text=g_strdup_printf("%s%s", wi->text ? wi->text : "", commit);
		g_free(wi->text);
		wi->text=text;
	}
        g_free(commit);
...
void
gui_internal_hic_flush(struct gui_priv *this, struct widget *wi)
{
	char *preedit;
	char *text=NULL;
	preedit = get_hic_preedit_string(this->hic);
	if (preedit != NULL && strlen(preedit) > 0) {
		text=g_strdup_printf("%s%s", wi->text ? wi->text : "", preedit);
		g_free(wi->text);
		wi->text=text;
	}
	if (wi->preedit) {
		...
		wi->preedit = NULL;
       	...
       	g_free(preedit);
	hangul_ic_flush(this->hic);
}

void
gui_internal_keypress_do_hangul(struct gui_priv *this, char *key)
{
	struct widget *wi,*menu,*search_list;
	int len=0;
	bool res=false;
	...
	if (wi) {
			...
			dbg(1,"backspace\n");
			res = hangul_ic_backspace(this->hic);
			if (res) {
				hic_preedit_update(this, wi);
			}
			else if (wi->text && wi->text[0]) {
				len=g_utf8_prev_char(wi->text+strlen(wi->text))-wi->text;
				wi->text[len]='\0';
			}
		} else {
			...
			ucs4 = g_utf8_to_ucs4((const gchar*)key, -1, NULL, NULL, NULL);
			ch=hangul_keyboard_table[*ucs4-0x3131];
			res = hangul_ic_process(this->hic, ch);
			hic_commit(this, wi);
			dbg(2,"text=%s\n",wi->text);
			hic_preedit_update(this, wi);
			dbg(2,"preedit=%s\n",wi->preedit);
